...
const navItems: SidebarLinkItem[] = [
  ...
  { label: 'Momentum',    href: '/momentum',    icon: <Flame           className="w-5 h-5 flex-shrink-0" /> },
  ...
  { label: 'Multi-Agent', href: '/multi-agent', icon: <Network         className="w-5 h-5 flex-shrink-0" /> },
  ...
  { label: 'Fix UI',      href: '/fix-ui',      icon: <Wrench          className="w-5 h-5 flex-shrink-0" /> },
